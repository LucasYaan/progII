        ...
        while (!sair) {
            ...
            switch (opcao) {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    // o programa deverá perguntar o preço -> produtos que têm preço menor ou igual ao informado (dica: use a classe CriterioPrecoMaximo).
                    System.out.print("Produto com preço máximo: ");
